...
carouselItem <- function(caption, image, link, index, interval) {
  ...
  item <- div(class = paste0("carousel-item", ifelse(index == 0, " active", "")),
              ...
              a(href = link, img(src = image, class = "d-block  mx-auto border", style = "width: 50%; max-width: 600px;  margin-bottom: 100px")),
              div(class = "carousel-caption d-none d-md-block",style = "  padding-bottom: 15px;",
